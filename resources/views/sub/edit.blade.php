        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <span class="pull-right">تعديل "{{$subscriber->firstname." ".$subscriber->lastname}}"</span>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <form action="{{route("update_sub", $subscriber->id)}}" method="post" enctype="multipart/form-data">
                                @csrf

                                <div class="form-group">
                                    <label>الإسم الشخصي</label>
                                    <input type="text" name="firstname" class="form-control" value="{{$subscriber->firstname}}" required>
                                </div>

                                <div class="form-group">
                                    <label>الإسم العائلي</label>
                                    <input type="text" name="lastname" class="form-control" value="{{$subscriber->lastname}}" required>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>المدينة</label>
                                    <input type="text" name="city" class="form-control" value="{{$subscriber->city}}">
                                </div>

                                <div class="form-group">
                                    <label>اسم الشارع</label>
                                    <input type="text" name="street" class="form-control" value="{{$subscriber->street}}">
                                </div>

                                <div class="form-group">
                                    <label>رقم الشارع</label>
                                    <input type="text" name="nstreet" class="form-control" value="{{$subscriber->nstreet}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    @if($subscriber->image)
                                        <img src="{{asset("storage/app/".$subscriber->image)}}" style="width: 160px;height: 160px; border: 1px solid #eee; display: block;">
                                    @else
                                        <img src="{{asset("public/noimage.jpg")}}" style="width: 160px;height: 160px; border: 1px solid #eee;  display: block;">
                                    @endif
                                </div>
...
@section("scripts")
    ...
    <script>
        $(function () {
            var country = "{{$subscriber->country}}";
