...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php echo e(route("home")); ?>">سابسكرايب</a>
    </div>
    <!-- /.navbar-header -->
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                <li>
                    <a href="<?php echo e(route("home")); ?>"><i class="fa fa-dashboard fa-fw"></i> الحسابات المسجلة</a>
                </li>
                <li>
                    <a href="<?php echo e(route("users")); ?>"><i class="fa fa-user fa-fw"></i> المستخدمون</a>
                </li>
                <li>
                    <a href="<?php echo e(route("fields")); ?>"><i class="fa fa-leaf fa-fw"></i> الحقول الإضافية</a>
                </li>
                <li></li>
                <li>
