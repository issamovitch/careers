            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="min-height: 600px;">
                    <div class="table-responsiveeee">
                        ...
                        <form action="<?php echo e(route("export")); ?>" class="col-sm-6" id="formm" method="post">
                            <?php echo csrf_field(); ?>
                                    ...
                                    <div class="col-sm-7">
                                        <select id="country" class="form-control filtermah" name="country">
                                            ...
                                            <?php $__currentLoopData = $registered_cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($c->value); ?>"><?php if($c->value): ?><?php echo e($c->value); ?><?php else: ?> لا توجد <?php endif; ?></option>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <?php $__currentLoopData = $subscribers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="odd gradeX helloo visible" data-id="<?php echo e($s->id); ?>" <?php if($s->nominated==1): ?> style="background: #c2f5ff;" <?php endif; ?> <?php if($s->nominated==2): ?> style="background: rgba(255,132,107,0.52);" <?php endif; ?>
        ...
        $(function () {
            ...
            $(document).on("click", "#btn-export", function (e) {
                ...
                if(arr.length<=0)
                    ...
                    $("#formm").attr("action", "<?php echo e(route("export")); ?>");
                    $("#formm").submit();
                }
            });
            ...
            $(document).on("click", "#btn-export-pdf", function (e) {
                ...
                if(arr.length<=0)
                    ...
                    $("#formm").attr("action", "<?php echo e(route("export2")); ?>");
                    $("#formm").submit();
                }
            });
