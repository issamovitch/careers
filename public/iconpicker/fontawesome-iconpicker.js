...
(function(a) {
    ...
    c.defaultOptions = {
        ...
        templates: {
            ...
            search: '<input type="search" class="form-control iconpicker-search" placeholder="أكتب إسم الأيقونة للبحث عنها" /><br><div style="text-align: right">تجد أسماء الأيقونات <a target="_blank" href="https://fontawesome.com/icons?d=gallery">هنا</a>.</div>',
